...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # from stack overflow:
    # ome classes (for example the standard library's socket class) define their own send method which has nothing to do with Object#send. So if you want to work with objects of any class, you need to use __send__ to be on the safe side.
  ...
  def test_explicitly_implementing_respond_to_lets_objects_tell_the_truth
    ...
    # because it doesn't have "foo" in the method name
